...
bool CDBEnv::Open(const boost::filesystem::path& pathIn)
{
    ...
    dbenv.set_lg_max(104857600);  // 100 MiB max log file (must be >= 4x log buffer)
    dbenv.set_lk_max_locks(250000);   // PoS requires high lock count for UTXO iteration
    dbenv.set_lk_max_objects(250000); // Match lock count for object handles
    dbenv.set_lk_max_lockers(10000);  // Thread/txn contexts - prevents locker exhaustion
